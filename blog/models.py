...
class Comment(models.Model):
    ...
    create_time = models.DateTimeField(auto_now_add=True)
    parent_comment = models.ForeignKey("self", null=True,blank=True)#blank为True意思在django.admin中可以不填这个字段

    def __str__(self):
        return self.content

    class Meta:
        verbose_name = "用户信息"  #改写表的名字为中文
        verbose_name_plural = verbose_name #去掉名字后面的s
